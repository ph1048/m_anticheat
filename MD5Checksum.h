...
public:
	...
	static LPTSTR GetMD5(BYTE* pBuf, UINT nLength);
	static LPTSTR GetMD5(HANDLE File);
	static LPTSTR GetMD5(LPCSTR strFilePath);
	static LPTSTR GetMD5(LPCWSTR strFilePath);
